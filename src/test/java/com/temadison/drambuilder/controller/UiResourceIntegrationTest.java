...
class UiResourceIntegrationTest {
    ...
    void servesDashboardAndStaticModules() throws Exception {
        ...
        mockMvc.perform(get("/data.html"))
                ...
                .andExpect(content().string(containsString("Refresh latest issuer data")))
                ...
                .andExpect(content().string(containsString("Refresh Latest Data")))
                .andExpect(content().string(containsString("Import Local File")))
        ...
        mockMvc.perform(get("/js/app.js"))
                ...
                .andExpect(content().string(containsString("hasMarketData && !hasDashboard ? runRoundhillIngestionFromUi : refresh")))
                .andExpect(content().string(containsString("Refreshing latest Roundhill data")))
